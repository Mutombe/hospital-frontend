  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-lg sm:text-xl hidden sm:block">MediCare Hub</span>
            </div>
      ...
      <motion.aside
        ...
        className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-white shadow-lg z-40 lg:translate-x-0 overflow-y-auto"
      >
      ...
      {/* Footer */}
      <footer className="bg-white shadow-inner lg:pl-64">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
